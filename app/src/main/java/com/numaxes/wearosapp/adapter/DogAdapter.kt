package com.numaxes.wearosapp.adapter
...
import com.numaxes.wearosapp.databinding.ItemDogBinding
    ...
    inner class ViewHolder(
        ...
        fun bind(dog: Dog) {
            ...
            binding.itemContainer.setOnClickListener {
                ...
                // Show speed only if position value indicates (for.numaxes. if not equal to 0 or 3)
